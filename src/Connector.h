 ...
 * where InputDataType == OutputDataType, OutputLayout = Layout_RCDB.
...
class Connector<DataType, InputLayout, DataType, Layout_RCDB, Connector_Lowering_R1C1>{
public:
    
    typedef Cube<DataType, InputLayout> InputCubeType;
    typedef Cube<DataType, Layout_RCDB> OutputCubeType;
...
class Connector<InputDataType, Layout_RCDB, OutputDataType, Layout_RCDB, Connector_Lowering_R1C1>{
public:
    
    typedef Cube<InputDataType, Layout_RCDB> InputCubeType;
    typedef Cube<OutputDataType, Layout_RCDB> OutputCubeType;
