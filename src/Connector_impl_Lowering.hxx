...
Connector<DataType, InputLayout, DataType, Layout_RCDB, Connector_Lowering_R1C1>::
...
template<typename DataType, LayoutType InputLayout>
void Connector<DataType, InputLayout, DataType, Layout_RCDB, Connector_Lowering_R1C1>::
transfer(InputCubeType * p_input_cube, OutputCubeType * p_output_cube){
    
    report_last_transfer.reset();
    
#ifdef _DO_WARNING
    std::cerr << "WARNING: " << "You are using the most general version of the lowering function. " <<
                                "This might be slow!" << std::endl;
#endif
